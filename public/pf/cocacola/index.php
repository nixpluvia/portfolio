...
<body>
    ...
    <div class="scroll-box">
        <div class="page page1">
            <div class="bg-video">
                <video width="100%" muted="muted" preload="auto" autoplay="" loop="" playsinline="">
                    <source src="./resource/Coca Cola - Anthem (Global Version).mp4" type="video/mp4">
                    <!-- <source src="./resource/Coca Cola - Anthem (Global Version).mp4" type="video/mp4"> -->
                </video>
            </div>
        ...
        <div class="page page2">
            <div class="wrap con">
                <figure class="main-img">
                    <img src="./resource/figure1.png" alt="존 펨버턴">
                </figure>

                <div class="page-bg  img-box no-drag">
                    <img src="./resource/bg1.png" alt="배경이미지">
                </div>
        ...
        <div class="page page3">
            ...
            <div class="page-bg img-box no-drag">
                <img src="./resource/bg2.png" alt="배경이미지">
            </div>
            ...
            <div class="slider" dir="rtl">
                <div id="slide1">
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand1.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand2.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand3.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand4.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand5.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand6.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand7.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
                    <div class="item">
                        <a class="block" href="">
                            <img src="./resource/brand8.png" alt="코카콜라 브랜드">
                        </a>
                    </div>
        ...
        <div class="page page4">
            <div class="wrap con">
                <div class="page-bg img-box no-drag">
                    <img src="./resource/bg3.png" alt="배경이미지">
                </div>
                ...
                <div class="content-img con">
                    <ul>
                        ...
                        <li class="con-img2 img-box" data-tab-name="box-1" data-tab-body-item-name="2">
                            <img src="./resource/vision-img.png" alt="">
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="page page5">
            <div class="wrap con">
                <div class="page-bg no-drag">
                    <img src="./resource/bg4.png" alt="배경이미지">
                </div>
                    ...
                    <div class="media-slider">
                        <div class="sliders">
                            <div class="media-slide1 active" data-tab-name="box-2" data-tab-body-item-name="1" data-slick-on="false">
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img1.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img2.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img3.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img4.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img5.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img6.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img7.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/promotion-img8.jpg)"></div>
                                    </a>
                                </div>
                            </div>
                            <div class="media-slide2" data-tab-name="box-2" data-tab-body-item-name="2" data-slick-on="false">
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img1.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img2.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img3.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img4.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img5.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img6.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img7.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/media-life-img8.jpg)"></div>
                                    </a>
                                </div>
                            </div>
                            <div class="media-slide3" data-tab-name="box-2" data-tab-body-item-name="3" data-slick-on="false">
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img1.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img2.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img3.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img4.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img5.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img6.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/community-img7.png)"></div>
                                    </a>
                                </div>
                            </div>
                            <div class="media-slide4" data-tab-name="box-2" data-tab-body-item-name="4" data-slick-on="false">
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/news-img1.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/news-img2.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/news-img3.jpg)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/news-img4.png)"></div>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <div style="background-image:url(./resource/news-img5.png)"></div>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="footer page page6">
            <div class="footer-menu con flex">
                <div class="logo">
                    <a href="#">
                        <img src="./resource/foot-logo.svg" alt="코카콜라-로고">
                    </a>
                </div>
                <nav class="menu">
                    <ul class="flex">
